...
pub extern "system" fn Sleep(fn_ptr: Option<fn(u32)>, dw_milliseconds: u32) {
    static CHAIN: Lazy<SleepSyscallFacade<NioSleepSyscall>> = Lazy::new(Default::default);
    CHAIN.Sleep(fn_ptr, dw_milliseconds);
}

trait SleepSyscall {
    extern "system" fn Sleep(&self, fn_ptr: Option<fn(u32)>, dw_milliseconds: u32);
}
...
impl SleepSyscall for NioSleepSyscall {
    extern "system" fn Sleep(&self, _: Option<fn(u32)>, dw_milliseconds: u32) {
